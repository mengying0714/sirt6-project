...
samtools sort -o $projPath/alignment/bam/rmDup/${histName}_bowtie2.rmDup.mapped.sorted.bam $projPath/alignment/bam/rmDup/${histName}_bowtie2.rmDup.mapped.bam                                                   
samtools index $projPath/alignment/bam/rmDup/${histName}_bowtie2.rmDup.mapped.sorted.bam
#optional                                                                                                              


bamCoverage --normalizeUsing RPGC --effectiveGenomeSize ${gsize} -b $projPath/alignment/bam/rmDup/${histName}_bowtie2.rmDup.mapped.sorted.bam -o $projPath/alignment/bigwig/rmDUp/${histName}_mapped.sorted.normalized.bw
