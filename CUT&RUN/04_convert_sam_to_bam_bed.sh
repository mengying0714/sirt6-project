...
seqDepthDouble=`samtools view -@ $cores -F 0x04 $projPath/alignment/removeDuplicate/${histName}_bowtie2.sorted.dupMarked.sam | wc -l`
seqDepth=$((seqDepthDouble/2))
echo $seqDepth >$projPath/alignment/removeDuplicate/bowtie2_summary/${histName}_bowtie2.sorted.dupMarked.seqDepth
...
samtools view -bS -F 0x04 $projPath/alignment/removeDuplicate/${histName}_bowtie2.sorted.dupMarked.sam >$projPath/alignment/bam/${histName}_bowtie2.mapped.bam
...
multiqc /cutRun/alignment/sam/*bowtie2.sam /cutRun/alignment/sam